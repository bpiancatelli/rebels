...
<div class="right_col" role="main">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">          
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <div class="x_content">
                        <?php 
                            echo form_open('statistique/search');
                        ?>
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" name="membre"> 
                                            ...
                                            <?php foreach($membres as $membre){?>
                                                <option value="<?php echo $membre->getIdMembre()?>">
                                                    <?php echo $membre->getNom()." ".$membre->getPrenom();?>
                                                </option>
                                            <?php } ?>                                                                                                
                                        </select>
                                    </td>
                                    ...
                                    <td>                                        
                                        <select class="form-control" name="division">
                                            <option value="na" selected>--- ---</option>
                                            <?php foreach($champtionnats as $champtionnat){?>
                                                <option value="<?php echo $champtionnat->getIdDivision() ?>">
                                                    <?php echo $champtionnat->getNom() ;?>
                                                </option>
                                            <?php } ?>
                                        </select>
                                    </td>                                    
                                ...
                                <tr>
                                    <td colspan="4">
                                        <div class="w_left w_30">
                                            <input class="btn btn-info" type="submit" name="submit_joueur" value="Rechercher" />
                                        </div>
                                    </td>  
                                </tr>
    ...
    <?php if(isset($resultats) && $resultats != null){ ?>
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">          
            <div class="x_panel">
                <div class="x_title">
