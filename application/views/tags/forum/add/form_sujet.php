    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">  
            <div class="x_panel tile fixed_height_350">
                ...
                <?php                     
                    echo form_open('forum/check/sujet/'.$idSujet);
                ?>  
                <form>
                    <table>
                        <tbody>
                            <div class="x_content">
                                <tr>
                                        ...
                                        <td>
                                            <div class="w_center w_50 col-md-offset-2" >
                                                <input type="text" name="titre_sujet"></input>
                                            </div>
                                        </td>
                                        <div class="clearfix"></div>
                                ...
                                <tr>
                                        ...
                                        <td>
                                            <div class="col-md-offset-2">
                                                <textarea name="sujet" style="width: 500px; height: 150px;" rows="4" cols="150"></textarea>
                                            </div>
                                        </td>
                                        <div class="clearfix"></div>
                                ...
                                <tr>
                                        ...
                                        <td>
                                            <div class="w_left w_30">
                                                <input class="btn btn-primary btn-block" type="submit" name="submit_sujet" value="Ajouter" />
                                            </div>
                                        </td>
                                        <div class="clearfix"></div>
